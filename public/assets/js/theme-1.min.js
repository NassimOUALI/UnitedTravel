...
var UseBootstrapSelect = (function () {
    ...
    var Fe = Object.defineProperty,
        qe = (e, t, s) =>
            t in e
                ...
                : (e[t] = s),
        ce = (e, t, s) => qe(e, typeof t != "symbol" ? t + "" : t, s);
    const We = (e, t) => e === t,
    ...
    const B = 1,
        te = 2,
        be = { owned: null, cleanups: null, context: null, owner: null };
    var y = null;
    let ue = null,
        Re = null,
        b = null,
    ...
    function D(e, t) {
        ...
        const s = {
            ...
            n = (i) => (typeof i == "function" && (i = i(s.value)), ye(s, i));
        return [Ee.bind(s), n];
    }
    function T(e, t, s) {
        const n = fe(e, t, !1, B);
    ...
    function Ge(e, t, s) {
        we = Je;
        const n = fe(e, t, !1, B);
        (n.user = !0), O ? O.push(n) : J(n);
    }
    function U(e, t, s) {
        s = s ? Object.assign({}, ee, s) : ee;
        const n = fe(e, t, !0, 0);
        return (
            (n.observers = null),
    ...
    function Ee() {
        if (this.sources && this.state)
            if (this.state === B) J(this);
            else {
                const e = A;
                (A = null), Y(() => ie(this), !1), (A = e);
            }
        if (b) {
    ...
    function Xe(e, t, s) {
        ...
        (!e.updatedAt || e.updatedAt <= s) &&
            (e.updatedAt != null && "observers" in e ? ye(e, n) : (e.value = n),
            (e.updatedAt = s));
    }
    function fe(e, t, s, n = B, i) {
        const r = {
            fn: e,
            state: n,
            updatedAt: null,
        ...
        return (
            y === null ||
                (y !== be && (y.owned ? y.owned.push(r) : (y.owned = [r]))),
            r
        );
    }
    function le(e) {
        if (e.state === 0) return;
        if (e.state === te) return ie(e);
        ...
        for (let s = t.length - 1; s >= 0; s--)
            if (((e = t[s]), e.state === B)) J(e);
            else if (e.state === te) {
                const n = A;
                (A = null), Y(() => ie(e, t[0]), !1), (A = n);
            }
    }
    function Y(e, t) {
        if (A) return e();
        ...
        try {
            ...
            s || (O = null), (A = null), Ae(n);
        }
    }
    function Qe(e) {
        if ((A && (xe(A), (A = null)), e)) return;
        const t = O;
        (O = null), t.length && Y(() => we(t), !1);
    }
    function xe(e) {
    ...
    function ie(e, t) {
        ...
        for (let s = 0; s < e.sources.length; s += 1) {
            ...
            if (n.sources) {
                const i = n.state;
                i === B
                    ? n !== t && (!n.updatedAt || n.updatedAt < se) && le(n)
                    : i === te && ie(n, t);
            }
        }
    }
    ...
    function $e(e) {
        ...
        return U(ze(() => e.each, e.children, t || void 0));
    }
    function q(e) {
        const t = e.keyed,
            s = U(() => e.when, void 0, {
    ...
    function st(e, t, s) {
        ...
        for (; c < i || l < r; ) {
            ...
            for (; t[i - 1] === s[r - 1]; ) i--, r--;
            if (i === c) {
                const u = r < n ? (l ? s[l - 1].nextSibling : s[r - l]) : g;
                for (; l < r; ) e.insertBefore(s[l++], u);
            } else if (r === l)
                for (; c < i; ) (!h || !h.has(t[c])) && t[c].remove(), c++;
            else if (t[c] === s[r - 1] && s[l] === t[i - 1]) {
                const u = t[--i].nextSibling;
                e.insertBefore(s[l++], t[c++].nextSibling),
                    e.insertBefore(s[--r], u),
                    (t[i] = s[r]);
            } else {
                if (!h) {
                    h = new Map();
                ...
                if (u != null)
                    if (l < u && u < r) {
                        ...
                        for (
                            ...
                            ++E < i &&
                            E < r &&
                            !((_ = h.get(t[E])) == null || _ !== u + w);

                        )
                            w++;
                        if (w > u - l) {
                            const N = t[c];
                            for (; l < u; ) e.insertBefore(s[l++], N);
                        } else e.replaceChild(s[l++], t[c++]);
                    } else c++;
                else t[c++].remove();
            }
        }
        ...
        return (
            ne((r) => {
                (i = r),
                    t === document
                        ? e()
                        : $(t, e(), t.firstChild ? null : void 0, s);
            }, n.owner),
            () => {
                i(), (t.textContent = "");
            }
    ...
    function lt(e, t = window.document) {
        const s = t[Le] || (t[Le] = new Set());
        for (let n = 0, i = e.length; n < i; n++) {
            const r = e[n];
            s.has(r) || (s.add(r), t.addEventListener(r, it));
        }
    }
    function Ie(e, t, s) {
    ...
    function it(e) {
        ...
        for (
            ...
            if (n && !s.disabled) {
                const i = s[`${t}Data`];
                if (
                    (i !== void 0 ? n.call(s, i, e) : n.call(s, e),
                    e.cancelBubble)
                )
                    return;
            }
    ...
    function oe(e, t, s, n, i) {
        for (; typeof s == "function"; ) s = s();
        if (t === s) return s;
        const r = typeof t,
            c = n !== void 0;
        if (
            ((e = (c && s[0] && s[0].parentNode) || e),
            r === "string" || r === "number")
        )
            if ((r === "number" && (t = t.toString()), c)) {
                ...
                s !== "" && typeof s == "string"
                    ...
                    : (s = e.textContent = t);
        else if (t == null || r === "boolean") s = G(e, s, n);
        else {
            if (r === "function")
                return (
                    T(() => {
            ...
            if (Array.isArray(t)) {
                const l = [],
                    g = s && Array.isArray(s);
                if (he(l, t, s, i))
                    return T(() => (s = oe(e, l, s, n, !0))), () => s;
                if (l.length === 0) {
                    if (((s = G(e, s, n)), c)) return s;
                } else
                    g
                        ? s.length === 0
                            ? ke(e, l, n)
    ...
    function he(e, t, s, n) {
        ...
        for (let r = 0, c = t.length; r < c; r++) {
            let l = t[r],
                ...
                h;
            if (!(l == null || l === !0 || l === !1))
                if ((h = typeof l) == "object" && l.nodeType) e.push(l);
                else if (Array.isArray(l)) i = he(e, l, g) || i;
                else if (h === "function")
                    if (n) {
                        for (; typeof l == "function"; ) l = l();
                        i =
    ...
    function rt(e, t) {
        if (e === "") return t;
        const s = t.toLowerCase().indexOf(e.toLowerCase());
        if (s !== -1) {
            const n = `<u>${t.slice(s, s + e.length)}</u>`;
            return t.slice(0, s) + n + t.slice(s + e.length);
        } else return t;
    }
    function K(e) {
        return e.filter((t) => t.value !== "");
    }
    var pe = k("<div>"),
        ot = k(
            '<div class="d-flex align-items-center gap-1 flex-wrap flex-grow-1 w-100 overflow-hidden">'
        ),
        at = k("<span role=button class=d-inline-flex>"),
        ct = k(
            '<div class="align-items-center gap-1 d-inline-flex py-0 border-0 btn text-bg-secondary">'
        ),
        ut = k("<div class=input-wrapper><span></span><input type=text>"),
        ft = k(
            '<span role=button class="ms-auto link-secondary d-inline-flex flex-shrink-0">'
        ),
        dt = k("<div class=dropdown-item>"),
        ht = k('<div class="dropdown-item active">'),
        gt = k('<div class="dropdown-item pe-none">'),
        pt = k('<div data-bs-popper class="dropdown-menu slideIn w-100">'),
        vt = k("<h6 class=dropdown-header>"),
        mt = k(
            '<svg class=pe-none xmlns=http://www.w3.org/2000/svg width=1em height=1em viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><line x1=18 y1=6 x2=6 y2=18></line><line x1=6 y1=6 x2=18 y2=18>'
        );
    const X = "use-bootstrap-select",
        wt = "d-flex align-items-center gap-1",
        _e = `${X}-target`,
        bt = `${X}-wrapper`,
        De = `${X}:show`,
        Oe = `${X}:hide`,
        ...
        Pe = class R {
            constructor(t, s) {
                ce(this, "selectElement"),
                    ce(this, "configObject"),
                    (this.selectElement = t),
                    (this.configObject = s),
                    this.init(),
                    R.instances.set(t, this);
            }
            getConfigFromGlobal() {
            ...
            getConfigFromAttributes() {
                const t = {};
                for (const [s, n] of Object.entries(Ve)) {
                    const i = this.selectElement.dataset[s],
                        r = typeof n == "boolean";
                    i && (t[s] = r ? i === "true" : i);
                }
                return t;
            ...
            getConfig() {
                const t = this.getConfigFromGlobal(),
                    s = this.configObject,
            ...
            setSelected(t, s, n = !0) {
                const i = new Set(t),
                    r = this.selectElement.options;
                for (let c = 0; c < r.length; c++) {
                    const l = r[c];
                    s && n !== !1 && (l.selected = !1),
                        i.has(l.value) && (l.selected = s);
                }
                this.update();
            }
            getValue() {
                if (this.selectElement.multiple) {
                    const t = K(this.getSelected()).map((s) => s.value);
                    return t.length === 0 ? null : t;
                } else {
                    const t = this.selectElement.value;
                    return t === "" ? null : t;
                }
            }
            setValue(t) {
                const s = ge(t);
                this.selectElement.multiple || s.splice(1),
                    this.setSelected(s, !0);
            }
            addValue(t) {
                const s = ge(t);
                this.setSelected(s, !0, !1);
            }
            removeValue(t) {
                const s = ge(t);
                this.setSelected(s, !1);
            }
            clearValue() {
                this.setSelected(
                    this.getSelected().map((t) => t.value),
                    !1
                );
            }
            addOption(t, s, n = !1, i = "first") {
                const r = s ?? t;
                if (
                    ...
                    (l.value = t), (l.textContent = r), (l.selected = n);
                    const g = this.selectElement.options;
                    if (g.length > 0)
                        if (i === "last") this.selectElement.append(l);
                        else {
                            const h = g[0];
                            h.value === ""
                                ? h.insertAdjacentElement("afterend", l)
                                : this.selectElement.prepend(l);
                        }
                    else this.selectElement.append(l);
                    this.update();
                }
            }
            update() {
            ...
            show() {
                this.selectElement.dispatchEvent(new Event(De));
            }
            hide() {
                this.selectElement.dispatchEvent(new Event(Oe));
            }
            toggle() {
                this.selectElement.dispatchEvent(new Event(Ne));
            }
            init() {
                R.instances.has(this.selectElement) ||
                    (this.render(), R.instances.set(this.selectElement, this));
            }
            getClassList() {
                return this.selectElement.classList.value.replace(_e, "");
            }
            getItems() {
                return K(Array.from(this.selectElement.options)).map((t) => {
                    var s;
                    return {
                        text: t.textContent,
                        value: t.value,
                        ...
                        disabled: t.disabled,
                        label:
                            ((s = t.parentElement) == null
                                ? void 0
                                : s.tagName) === "OPTGROUP"
                                ? t.parentElement.label
                                : void 0,
                    };
                });
            }
            getSelected() {
                return Array.from(this.selectElement.selectedOptions).map(
                    (t) => ({ value: t.value, text: t.textContent })
                );
            }
            render() {
                (this.selectElement.tabIndex = -1),
                    this.selectElement.classList.add(_e);
                const t = document.createElement("div");
                (t.className = `${bt} w-100`),
                    this.selectElement.insertAdjacentElement("afterend", t);
                const s = () => {
                    const [n, i] = D(this.getConfig()),
                        [r, c] = D(this.getClassList()),
                        [l, g] = D(this.selectElement.multiple),
                        [h, u] = D(this.selectElement.disabled),
                        [E, w] = D(""),
                        [_, N] = D(this.getItems()),
                        [L, Q] = D(this.getSelected()),
                        V = () => (
                            _(),
                            this.getItems()
                                .filter((a) =>
                                ...
                                .map((a) => ((a.text = rt(E(), a.text)), a))
                        );
                    let I, S, C;
                    this.selectElement.addEventListener("change", () => {
                        i(this.getConfig()),
                            c(this.getClassList()),
                            g(this.selectElement.multiple),
                            u(this.selectElement.disabled),
                            N(this.getItems()),
                            Q(this.getSelected());
                    }),
                    ...
                    const [P, ae] = D(!1),
                        ...
                        yt = () =>
                            ...
                            this.selectElement.options[0].value === "",
                        xt = () =>
                            yt() && K(L()).length < 1
                    ...
                    function me() {
                        S.querySelectorAll(".dropdown-item").forEach((a) =>
                            a.classList.remove("active")
                        );
                    }
                    function Ue(a) {
                        return (
                            a.classList.contains("dropdown-header") ||
                    ...
                    function At(a) {
                        const d = S.querySelector(".dropdown-item.active");
                        let o;
                        if (d) o = je(d, a);
                        else {
                            const f = S.querySelectorAll(".dropdown-item"),
                                p = a === "ArrowDown" ? f[0] : f[f.length - 1];
                            p && (Ue(p) ? (o = je(p, a)) : (o = p));
                        }
                        return o;
                    }
                    const Me = () => {
                        this.addOption(E(), E(), !0, n().createPosition),
                            w(""),
                            l() || H();
                    };
                    this.selectElement.addEventListener(De, () => {
                        W(), C.focus();
                    }),
                        this.selectElement.addEventListener(Oe, H),
                        this.selectElement.addEventListener(Ne, () => {
                            j() ? H() : (W(), C.focus());
                        });
                    const Ct = ({ children: a }) =>
                            (() => {
                                var d = pe();
                                return (
                                    (d.$$mousedown = (o) => o.preventDefault()),
                                    $(d, a),
                                    T(() => Te(d, `drop${n().position} ${X}`)),
                                    d
                                );
                            })(),
                        $t = ({ children: a }) =>
                        ...
                        _t = () => {
                            ...
                            return m(q, {
                                ...
                                get children() {
                                    ...
                                    return (
                                        (d.$$click = (o) => {
                                            o.stopPropagation(), a.clearValue();
                                        }),
                                        $(d, m(Be, {})),
                                        T(() =>
                                            d.classList.toggle(
                            ...
                            return (() => {
                                ...
                                return (
                                    (o.$$click = () => {
                                        l()
                                            ? d.addValue(a.value)
                                            : (d.setValue(a.value), H());
                                    }),
                                    (o.$$mouseover = (f) => {
                                        me(), f.target.classList.add("active");
                                    }),
                                    T(
                                        (f) => {
                                            var p = a.value,
            ...
            static getOrCreateInstance(t) {
                let s = R.instances.get(t);
                return s || (s = new R(t)), s;
            }
            static clearAll(t) {
                (t || document).querySelectorAll("select").forEach((s) => {
                    const n = R.instances.get(s);
                    n && n.clearValue();
                });
            }
        };
    ce(Pe, "instances", new Map());
    let Et = Pe;
    function Be() {
        return mt();
    }
    return lt(["mousedown", "click", "keydown", "input", "mouseover"]), Et;
})();
